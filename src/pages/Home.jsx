...
export default function Home() {
  ...
  return (
    <>
      <title>Glo Event Co - Party Equipment Rental in St. Louis</title>
      <meta
        name="description"
        content="Silent Disco + Photo Booth (Selfie Station) rentals in St. Louis & nearby areas."
      />
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(photoBoothServiceLD),
        }}
      />
 ...
 <NeonSign
  as="h1"
  color="pink"   // 👈 ESTO lo vuelve rojo
  flicker="slow"
  className="
    mt-3 leading-none
    whitespace-nowrap
...
>
  ...
  <span className="neon-text-mint">Photo Booth</span>
              ...
              <p className="sr-only">
  Silent Disco rentals and Photo Booth rentals in St. Louis, Missouri and surrounding areas by Glo Event Co.
</p>


              <p className="mt-5 text-gray-400 max-w-xl">
              Modern experiences for weddings, corporate events, and private parties. Clean setups, local support, and custom branding that keeps guests talking.
              </p>
  ...
  See Pricing + Book Online
            ...
            <div className="relative rounded-2xl glass glo-on-blue glo-hover z-0 mt-6 md:mt-0 overflow-hidden">
              <video
                ...
                >
               <source src="/videos/silent-disco-st-louis-event-hero.webm" type="video/webm" />
<source src="/videos/silent-disco-st-louis-event-hero.mp4" type="video/mp4" />
