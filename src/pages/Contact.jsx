  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Reach out for availability and quotes. Serving St. Louis & surrounding areas."
        />
        <link rel="canonical" href="https://www.gloeventco.com/contact" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-10 items-start">
          ...
          <div className="glass rounded-2xl p-6">
            ...
            {/* Styling: match dark theme (✅ safer: don’t hide ALL links) */}
            <style>{`
              ...
              /* ✅ Targeted hide: only if CheckCherry injects a reload link/button */
              .checkcherry__widget__contact-form a[href*="reload"],
              .checkcherry__widget__contact-form a:has(span):where(:contains("Reload")) {
