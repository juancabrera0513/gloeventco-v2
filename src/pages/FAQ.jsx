...
is due 7 days prior to your event. We accept all major credit cards and PayPal.`,
  ...
  },
  {
    ...
    a: 'Yes. Our Photo Booth (Selfie Station) offers photos, GIFs, and boomerangs with branded overlays and instant sharing.'
  },  
  {
...
export default function FAQ() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <NeonHeading kicker="" title="Frequently Asked Questions" />
